...
export const { usecase1Usecase_index } = createUsecase.index({ name, thunks, selectors });
export const { usecase1Usecase_setup } = createUsecase.setup({ name, actions, reducer });
